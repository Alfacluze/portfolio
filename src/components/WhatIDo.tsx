        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Cleaning, analyzing, and interpreting data using Python and SQL
                to discover patterns, answer questions, and support better
                decision making.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DATA SCIENCE</h3>
              <h4>Building Models and Practical Solutions</h4>
              <p>
                Working on machine learning and data-driven projects that turn
                datasets into useful predictions, visualizations, and practical
                solutions.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
